...
import { BarChart3, Images, LogOut, Shirt, Tags, Ticket,  Sparkles, Megaphone, Wallet, Trash2, } from "lucide-react";
...
const nav = [
  ...
  { to: "/admin/avisos", label: "Barra de avisos", icon: Megaphone, exact: false, },
  { to: "/admin/taxonomias", label: "Categorias & marcas", icon: Tags, exact: false },
  { to: "/admin/limpeza", label: "Limpeza de imagens", icon: Trash2, exact: false },
