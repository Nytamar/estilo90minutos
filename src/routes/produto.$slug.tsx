...
import { Heart, Minus, Plus, Share2, ShieldCheck, Truck, MessageCircle, Clock, ShoppingBag } from "lucide-react";
    ...
    <div className="mx-auto max-w-7xl py-10 sm:px-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2 lg:gap-10">
        <div className="flex h-fit flex-col-reverse gap-3 self-start sm:flex-row">
          ...
          <div
            className="surface-card min-w-0 flex-1 overflow-hidden rounded-[1.75rem]"
      ...
      {related.length > 0 && (
        <section className="mt-20 px-4 sm:px-0">
          ...
          <div className="mt-6">
            <ProductScroller>
              {related.map((p) => (
                <div key={p.id} className="w-[42%] shrink-0 snap-start sm:w-56 md:w-64">
